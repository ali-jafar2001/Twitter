...
public class TimeLineConfig extends SwingConfig {
	private String bcImage, btImage, obcImage , likeImage , retweetImage , clockImage;
	...
	public TimeLineConfig(String name) {
		super(name);
		init();
	}
	...
	protected void setProperties() {
		try {
			this.properties = ConfigLoader.getInstance().getTimeLinePanelProperties(name);
